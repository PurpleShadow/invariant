...
%*************************************************************************************************************
%-------------------------------------------------------------------------
\Abstract{In our previous work, we gave a necessary and sufficient condition for an semi-algebraic set to be an invariant of a polynomial autonomous dynamical system, which gave a confirmative answer to the open problem. In addition, based on which a relative complete algorithm for generating all semi-algebraic invariants
