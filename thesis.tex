...
%*************************************************************************************************************
\biaoti{GENERATING SEMI-ALGEBRAIC INVARIANTS FOR NON-AUTONOMOUS POLYNOMIAL HYBRID SYSTEMS$^*$}%%%   Main Title of your paper  %%%
{\uppercase{Surname1} Firstname1 \cdd \uppercase{WANG}
Qiuye \cdd \uppercase{Surname3} Firstname3}%%% The names of the authors  %%%
{ZHAN Naijun\\
...
\dshm{20XX}{XX}{GENERATING INVARIANTS FOR NON-AUTONOMOUS HYBRID SYSTEMS}{\uppercase{Surname1
Firstname1} $\cdd$ \uppercase{WANG QIUYE} $\cdd$
...
%*************************************************************************************************************
%-------------------------------------------------------------------------
\Abstract{We explore the problem of automatic invariant generation for non-autonomous polynomial hybrid systems. Related definitions are made clearer for the rarely visited non-autonomous case. Furthermore, we present a sound and complete algorithm to verify semi-algebraic invariants for non-autonomous polynomial hybrid systems. From it, we derive a sound and relatively complete algorithm to generate such invariants. Relativity means the algorithm needs a pre-defined template.}      % the abstract

\Keywords{Hybrid Systems, polynomial ideals, non-autonomous, invariants}        % the keywords
